...
// import 'package:get_real/main.dart';
// import 'package:get_real/utils/common.dart';

// import '../../utils/commonMethods.dart';
// import '../../utils/commonWidgets/commonAppBar.dart';
// import '../../utils/commonWidgets/commonTextClass.dart';
...
//   String _currentUserId = sharedPreferences.getString(userIdKey) ?? "";
...
//                     "receiver_name":
//                     document.get('receiver_id') != _currentUserId.toString()
...
//                       globalContext,
//                       MaterialPageRoute(
//                           builder: (context) => ChatConversationScreen(roomDetail: json,)));
...
//                             ),*/
//                             Container(
//                               padding: EdgeInsets.all(size.width * numD005),
...
//                               child: CommonText(
//                                   title: document.get("message_type") == "text"?document.get('message'):"Image",
//                                   fontSize: numD035,
